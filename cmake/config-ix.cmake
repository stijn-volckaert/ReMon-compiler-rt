...
set(ALL_SYNC_SUPPORTED_ARCH ${X86} ${X86_64})
...
if(APPLE)
  ...
  filter_available_targets(SYNC_SUPPORTED_ARCH ${ALL_SYNC_SUPPORTED_ARCH})
endif()
...
if (COMPILER_RT_HAS_SANITIZER_COMMON AND SYNC_SUPPORTED_ARCH AND
    OS_NAME MATCHES "Linux")
  set(COMPILER_RT_HAS_SYNC TRUE)
else()
  set(COMPILER_RT_HAS_SYNC FALSE)
endif()
